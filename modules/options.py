...
parser.add_argument("--precision", type=str, help="evaluate at this precision", choices=["fp32", "bf16", "fp16", "int4", "int8", "mps"])
parser.add_argument("--model", type=str, help="select chatglm model version", choices=["chatglm", "chatglm2", "chatglm3", "chatglm4"])
